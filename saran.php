...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div  class="kotak_login">
		...
		<p class="tulisan_login"> FORM SARAN DAN PERTANYAAN </p>
 	
		<form action="ceklogin.php" method="post">
			<label>Saran</label>
			<input type="text" name="User" class="form_login" placeholder="Tulis saran..">
 
			<label>Pertanyaan</label>
			<input type="text" name="Pass" class="form_login" placeholder="Tulis pertanyaan ..">
 
			<input type="submit" class="tombol_login"  value="SEND">
